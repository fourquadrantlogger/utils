...
public class BitSet {
	...
	*/
     ...
     */
    public void include(int i) throws IndexOutOfBoundsException {
        if (i >= maxSize)
     ...
     */
    public void exclude(int i) throws IndexOutOfBoundsException {
        if (i >= maxSize)
            throw new IndexOutOfBoundsException("exclude: " + i + "  is too large be inside the set");
        clearBit(i);
    }
     ...
     */
    public BitSet getSet(BitSet setA) {
        if (byteArray.length < setA.byteArray.length)
            throw new IndexOutOfBoundsException("getSet: source set larger than dest. set");
        clear();
